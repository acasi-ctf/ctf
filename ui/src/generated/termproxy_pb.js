...
goog.exportSymbol('proto.ResizeMessage', null, global);
 ...
 * @constructor
 */
proto.ResizeMessage = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.ResizeMessage, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.ResizeMessage.displayName = 'proto.ResizeMessage';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.ClientMessage.oneofGroups_ = [[1,2,3]];
...
proto.ClientMessage.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    resize: (f = msg.getResize()) && proto.ResizeMessage.toObject(includeInstance, f)
  };
...
proto.ClientMessage.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = new proto.ResizeMessage;
      reader.readMessage(value,proto.ResizeMessage.deserializeBinaryFromReader);
      msg.setResize(value);
      break;
    default:
      reader.skipField();
...
proto.ClientMessage.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      3,
      f,
      proto.ResizeMessage.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {?proto.ResizeMessage}
 */
proto.ClientMessage.prototype.getResize = function() {
  return /** @type{?proto.ResizeMessage} */ (
    jspb.Message.getWrapperField(this, proto.ResizeMessage, 3));
};


/**
 * @param {?proto.ResizeMessage|undefined} value
 * @return {!proto.ClientMessage} returns this
*/
proto.ClientMessage.prototype.setResize = function(value) {
 ...
 * @return {!proto.ClientMessage} returns this
 */
proto.ClientMessage.prototype.clearResize = function() {
 ...
 * @return {boolean}
 */
proto.ClientMessage.prototype.hasResize = function() {
 ...
 * @return {!Object}
 */
proto.ResizeMessage.prototype.toObject = function(opt_includeInstance) {
  return proto.ResizeMessage.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.ResizeMessage} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.ResizeMessage.toObject = function(includeInstance, msg) {
  var f, obj = {
    columns: jspb.Message.getFieldWithDefault(msg, 1, 0),
 ...
 * @return {!proto.ResizeMessage}
 */
proto.ResizeMessage.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.ResizeMessage;
  return proto.ResizeMessage.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.ResizeMessage} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.ResizeMessage}
 */
proto.ResizeMessage.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.ResizeMessage.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.ResizeMessage.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.ResizeMessage} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.ResizeMessage.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {number}
 */
proto.ResizeMessage.prototype.getColumns = function() {
...
/**
 * @param {number} value
 * @return {!proto.ResizeMessage} returns this
 */
proto.ResizeMessage.prototype.setColumns = function(value) {
 ...
 * @return {number}
 */
proto.ResizeMessage.prototype.getRows = function() {
 ...
 * @return {!proto.ResizeMessage} returns this
 */
proto.ResizeMessage.prototype.setRows = function(value) {
